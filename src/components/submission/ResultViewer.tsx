      ...
      <div className="flex items-center space-x-3">
        {status === "PENDING" && (
          <>
            ...
            <span className="text-blue-400 font-medium text-lg animate-pulse">채점 중...</span>
          </>
        )}
        ...
        {status === "AC" && (
          <>
            ...
            <span className="text-green-400 font-bold text-lg">맞았습니다!!</span>
          </>
        )}
        ...
        {status === "WA" && (
          <>
            ...
            <span className="text-red-400 font-bold text-lg">틀렸습니다</span>
          </>
        )}
      </div>
