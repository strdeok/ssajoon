...
export function SubmissionCodeItem({ submission }: SubmissionCodeItemProps) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-all duration-200 hover:border-zinc-300 dark:hover:border-zinc-700">
      ...
      {/* 펼쳤을 때 코드 영역 */}
      {isOpen && (
        <div className="border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-[#0a0a0a] p-4 relative">
          {isLoading ? (
