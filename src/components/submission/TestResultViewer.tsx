        ...
        >
          ...
          <div className={`transition-all duration-300 ${expandedIndex === idx ? 'max-h-96 border-t border-black/5 dark:border-white/5 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
            <div className="p-4 space-y-4">
              <div>
                <div className="text-xs font-semibold text-zinc-500 uppercase mb-1">Input</div>
              ...
              <div>
                <div className="text-xs font-semibold text-zinc-500 uppercase mb-1">Expected Output</div>
              ...
              <div>
                <div className="text-xs font-semibold text-zinc-500 uppercase mb-1">Actual Output</div>
