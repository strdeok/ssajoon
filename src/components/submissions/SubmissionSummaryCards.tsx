...
export default function SubmissionSummaryCards({ summary }: Props) {
  return (
    ...
    <div className="flex gap-4">
      {/* 1. 총 제출 카드 */}
      <div className="flex flex-col items-start justify-center px-6 py-4 bg-white border border-gray-200 rounded-xl shadow-sm min-w-[140px]">
        {/* 라벨 텍스트: 작고 회색으로 처리하여 보조 역할임을 강조 */}
        <span className="text-sm font-medium text-gray-500 mb-1">총 제출</span>
      ...
      <div className="flex flex-col items-start justify-center px-6 py-4 bg-white border border-gray-200 rounded-xl shadow-sm min-w-[140px]">
        {/* 라벨 텍스트: 작고 회색으로 처리 */}
        <span className="text-sm font-medium text-gray-500 mb-1">정답률</span>
